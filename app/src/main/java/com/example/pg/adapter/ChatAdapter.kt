...
class ChatAdapter(private var context: Context, private var chatList : ArrayList<Chat>) : RecyclerView.Adapter<ChatAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.custom_chat_item, parent, false))
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (user.imageUrl.equals("default")){
            holder.profile.setImageResource(R.drawable.pic)
        } else {
